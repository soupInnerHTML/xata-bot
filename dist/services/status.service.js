...
var StatusService = exports.StatusService = /*#__PURE__*/function (_ApiService) {
  ...
  _inherits(StatusService, _ApiService);
  return _createClass(StatusService, [{
    key: "getCurrentStatus",
    value: function () {
      var _getCurrentStatus = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var data, status;
    ...
    value: function () {
      var _setCurrentStatus = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(status) {
